...
class ProspettoPDFLaureando {
    ...
    public function creaPaginaLaureando($laureando, $formula, $cfuRichiesti) {
        ...
        $html .= '
            <table class="esami">
                <tr>
                    <td class="myTh" style="width: 80%" >ESAME</td><td class="myTh">CFU</td><td class="myTh">VOT</td><td class="myTh">MED</td>
                </tr>';
        ...
        $cfuTotaliMedia = $laureando->calcolaCFUTotaliMedia();
    ...
    public function generaPDFConSimulazione($laureando){
        ...
        if($tStep == 0){
            ...
            // varia solo il voto di tesi T
            $html .= '<tr>
                            <td class="myTh">VOTO TESI (T)</td>
                            <td class="myTh">VOTO LAUREA</td>
                            </tr>';
            $p = $tMin;
            $step = $tStep;
